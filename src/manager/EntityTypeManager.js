...
import type_value from '../mock/types/entity/value.json'
import type_and from '../mock/types/entity/and.json'
import type_or from '../mock/types/entity/or.json'
import type_divide from '../mock/types/entity/divide.json'
import type_add from '../mock/types/entity/add.json'
import type_sub from '../mock/types/entity/sub.json'
import type_mul from '../mock/types/entity/mul.json'
import type_concat from '../mock/types/entity/concat.json'
